...
const DEFAULT_DESCRIPTION = 'Biblioteca digital de resumos de livros católicos clássicos com leitura online, EPUB e PDF. Títulos: A Imitação da Bem-Aventurada Virgem Maria, A Noite Escura da Alma, A Prática da Presença de Deus, A Síntese Tomista, As Confissões, As Três Conversões e as Três Vias, A Subida do Monte Carmelo, Cartas, Crescimento na Santidade, Cristo Rei, Deus Caritas Est, Diálogos, Dilexi Te, Ética a Nicômaco, Filosofia 101, Magnifica Humanitaes, Nossa Senhora de Fátima, O Diário de Santa Faustina, O Grande Meio da Oração, O Homem Eterno, Os Irmãos Karamazov, O Grande Desconhecido: O Espírito Santo e seus Dons, Sobre o Ente e a Essência e Vida e Glórias de São José.';
